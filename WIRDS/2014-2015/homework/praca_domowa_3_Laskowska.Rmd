...
Modle regresji mo¿emy zapisaæ nastêpuj¹co
$$
Y=\beta X+\varepsilon.
$$
...
Wykres przdstawia zalenoœæ miêdzy `dist` a `speed` oraz oszacowan¹ krzyw¹ regresji. Nale¿y u¿yæ funkcji `plot` oraz `abline`.
